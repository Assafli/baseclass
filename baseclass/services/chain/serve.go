...
import (
	...
	chaincmdrunner "github.com/ignite/cli/baseclass/pkg/chaincmd/runner"
	"github.com/ignite/cli/baseclass/pkg/cosmosfaucet"
	"github.com/ignite/cli/baseclass/pkg/dirchange"
	"github.com/ignite/cli/baseclass/pkg/localfs"
	"github.com/ignite/cli/baseclass/pkg/xexec"
	"github.com/ignite/cli/baseclass/pkg/xfilepath"
	"github.com/ignite/cli/baseclass/pkg/xhttp"
...
If the new code is no longer compatible with the saved state, you can reset the database by launching:`), "baseclass chain serve --reset-once")
