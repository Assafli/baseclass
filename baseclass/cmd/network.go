...
import (
	...
	"github.com/ignite/cli/baseclass/pkg/events"
	"github.com/ignite/cli/baseclass/pkg/gitpod"
	"github.com/ignite/cli/baseclass/services/network"
	"github.com/ignite/cli/baseclass/services/network/networkchain"
	"github.com/ignite/cli/baseclass/services/network/networktypes"
)
...
func (n NetworkBuilder) Network(options ...network.Option) (network.Network, error) {
	...
	if from != "" {
		...
		if err != nil {
			return network.Network{}, errors.Wrap(err, "make sure that this account exists, use 'baseclass account -h' to manage accounts")
		}
	}
