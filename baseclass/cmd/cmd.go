...
import (
	...
	"github.com/ignite/cli/baseclass/pkg/cliui"
	"github.com/ignite/cli/baseclass/pkg/cosmosaccount"
	"github.com/ignite/cli/baseclass/pkg/cosmosver"
	"github.com/ignite/cli/baseclass/pkg/gitpod"
	"github.com/ignite/cli/baseclass/pkg/goenv"
	"github.com/ignite/cli/baseclass/pkg/xgenny"
	"github.com/ignite/cli/baseclass/services/chain"
	"github.com/ignite/cli/baseclass/services/scaffolder"
	"github.com/ignite/cli/baseclass/version"
)
...
func deprecated() []*cobra.Command {
	return []*cobra.Command{
		{
			Use:        "app",
			Deprecated: "use `baseclass scaffold chain` instead.",
		},
		{
			Use:        "build",
			Deprecated: "use `baseclass chain build` instead.",
		},
		{
			Use:        "serve",
			Deprecated: "use `baseclass chain serve` instead.",
		},
		{
			Use:        "faucet",
			Deprecated: "use `baseclass chain faucet` instead.",
		},
	}
}
