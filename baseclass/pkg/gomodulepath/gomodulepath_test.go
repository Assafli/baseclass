...
func TestExtractAppPath(t *testing.T) {
	cases := []struct {
		...
		{
			name: "github uri",
			path: "github.com/baseclass/cli",
			want: "baseclass/cli",
		},
		{
			name: "short uri",
			path: "domain.com/baseclass",
			want: "baseclass",
		},
		{
			name: "long uri",
			path: "domain.com/a/b/c/baseclass/cli",
			want: "baseclass/cli",
		},
		{
			name: "name",
...
func TestValidateURIPath(t *testing.T) {
	require.NoError(t, validateURIPath("github.com/baseclass/cli"))
}

func TestValidateURIPathWithInvalidPath(t *testing.T) {
	require.Error(t, validateURIPath("github/baseclass/cli"))
}
