...
func TestTCP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "tcp://github.com/baseclass/cli",
			want: "tcp://github.com/baseclass/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/baseclass/cli",
			want: "tcp://github.com/baseclass/cli",
		},
		{
			name: "with invalid scheme",
			addr: "ftp://github.com/baseclass/cli",
			want: "tcp://github.com/baseclass/cli",
		},
		{
...
func TestWS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "ws://github.com/baseclass/cli",
			want: "ws://github.com/baseclass/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/baseclass/cli",
